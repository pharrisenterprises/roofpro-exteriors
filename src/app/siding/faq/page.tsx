...
export const metadata = {
  title: "Siding FAQs | RoofPro Exteriors",
  description: "Common siding questions answered by our Richmond, VA team.",
};
...
export default async function Page() {
  const faqs = await client.fetch(QUERY, { serviceSlug: "siding" });

  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-bold mb-6">Siding FAQs</h1>
