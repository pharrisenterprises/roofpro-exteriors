...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data?.seo?.title ?? "Siding | RoofPro Exteriors";
  const description = data?.seo?.description ?? "Professional siding installation and repair services in Richmond, VA.";
  ...
  if (!data) {
    return (
      <main className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Siding</h1>
