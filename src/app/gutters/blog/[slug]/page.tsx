...
export const metadata = {
  title: "Gutters Blog Post | RoofPro Exteriors",
  description: "Gutter care insights from RoofPro Exteriors.",
};
...
export default async function GuttersPostPage({ params }: { params: { slug: string } }) {
