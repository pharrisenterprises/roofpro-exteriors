...
export default function ServiceFromSanity({ title, heroImage, intro, sections }: Props) {
  return (
    <main className="mx-auto max-w-6xl px-4 py-12 space-y-12">
      ...
      <section id="cta" className="rounded-2xl border p-6">
        ...
        <a href="mailto:sales@roofproexteriors.com" className="mt-4 inline-block underline">
          Email us
        </a>
      </section>
    </main>
